...
# project root path
project_path = "C:/Users/Earl/Documents/CODING/CYCU/PROJV2_3_1/mitbih"
...
def main():
    ...
    for i in range(5):  # Assuming you have 5 classes
        true_negative = np.sum(np.delete(confusion, i, 0)[:, np.delete(np.arange(5), i)])
        false_positive = np.sum(confusion[np.delete(np.arange(5), i), i])
