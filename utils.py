...
# wavelet denoise preprocess using mallat algorithm Earl Levi
def denoise(data):
...
def get_data_set(number, X_data, Y_data):
    ...
    record = wfdb.rdrecord('C:/Users/Earl/Documents/CODING/CYCU/PROJV2_3_1/mitbih/' + number, channel_names=['MLII'])
    data = record.p_signal.flatten()
    rdata = denoise(data=data)

    # get the positions of R-wave and the corresponding labels
    annotation = wfdb.rdann('C:/Users/Earl/Documents/CODING/CYCU/PROJV2_3_1/mitbih/' + number, 'atr')
